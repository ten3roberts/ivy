 ...
 use ivy_core::{
     ...
     App, Color, ColorExt, EntityBuilderExt, Layer,
 };
 use ivy_engine::{is_static, RigidBodyBundle, TransformBundle};
 use ivy_game::{fly_camera::FlyCameraPlugin, CharacterControllerBundle, MoverBundle, navigation::{MovementConfiguration, MovementConstraint, MovementMode, mover::MoverPlugin}, controllers::character_controller::CharacterControllerPlugin};
 ...
 fn setup_objects(world: &mut World, assets: AssetCache) -> anyhow::Result<()> {
     ...
     let capsule = |position: Vec3, rotation: Quat| {
         ...
         builder
             ...
             .mount(MoverBundle { conf: MOVEMENT_CONFIG })
             .mount(
